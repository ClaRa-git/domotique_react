...
const PopupAccount = ( { data, callable } ) => {
	...
	return (
		<div className='z-30 absolute top-0 right-0 bottom-0 left-0 backdrop-blur flex items-center justify-center' >
			<div className='flex relative w-full sm:w-2/3 lg:w-1/2 h-1/2 rounded-lg justify-center items-center bg-primary border-white' >
							...
							(
								<div className='flex flex-col w-full text-white'>
									...
									<button
										type='button'
										onClick={ callable }
										className='w-full bg-secondary-orange font-bold py-3 mt-2 rounded-lg transition'
									>
										Annuler
									</button>
								</div>								
